                                        ...
                                        <div class=" form">
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" method="post" action="PostController" novalidate="novalidate">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="username" name="postid" type="text" value="" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for="fullname" class="control-label col-lg-2">Title *</label>
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="fullname" name="title" type="text" value="" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="input-group">
                                                            <input class="form-control" placeholder="yyyy-mm-dd" id="datepicker" type="text" name="createdate">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <br></br>
                                                        <input class="form-control col-lg-10" id="image" name="image" type="text" value="" placeholder="url your image">
                                                    </div>
                                                </div>
                                                 <div class="form-group ">
                                                    <label for="email" class="control-label col-lg-2">Rate *</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control " id="rate" name="rate" type="text" value="">
                                                    </div>
                                                </div>                                          
                                                <div class="form-group ">
                                                    <label for="agree" class="control-label col-lg-2 col-sm-3">Author</label>
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="phone" name="author" type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-10">
                                                        <button class="btn btn-success btn-custom waves-effect waves-light m-b-5" 
                                                                type="submit" name="act" value="Save" onclick="customSubmit(10)"/>Save</button>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body"> 
                                                            ...
                                                            <textarea class="summernote" name="note" id="summernote">Hello Quylk</textarea>
