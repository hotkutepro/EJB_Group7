                                        ...
                                        <div class=" form">
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="signupForm" method="get" action="UserController" novalidate="novalidate">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class="form-control " id="confirm_password" name="confirm_password" type="password" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-10">
                                                        <button class="btn btn-success btn-custom waves-effect waves-light m-b-5" type="submit" name="btSubmit" value="Save">Save</button>
                                                          ...
                                                          <% 
                                                            ...
                                                            <%
                                                             ...
                                                             if(((session.getAttribute("ssRole")).toString()).equals("0")
                                                                     && (session.getAttribute("ssRole"))!= null ){
                                                                 %>
                                                                    <option name="administrator" value="0">Administrator</option>
                                                                    <option name="manager" value="1">Manager</option>
                                                                    <option name="poster" value="2">Poster</option>
                                                                    <option name="writer" value="3">Writer</option>
                                                                    <option name="reader" value="4">Reader</option>  
                                                                 <%
                                                              }
                                                          %>
