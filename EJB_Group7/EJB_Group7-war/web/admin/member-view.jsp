                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Gender</th>
                                            <th>PhomeNumber</th>
                                            <th style="width: 160px;">Role(s)</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>${p.getRole()}</td>
                                            <td class="actions">
                                                <a href="UserController?act=edit&userName=${p.getUserName()}" class="btn btn-icon waves-effect waves-light btn-custom btn-primary m-b-5"> <i class="fa fa-eye-slash "></i></a>
                                                <a href="UserController?act=del&userName=${p.getUserName()}" class="btn btn-icon waves-effect waves-light btn-custom btn-danger m-b-5"> <i class="fa fa-remove "></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
